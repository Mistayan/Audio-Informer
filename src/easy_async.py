...
class AsyncRequest:
    ...
    def add_done_callback(self, callback):
        """ Add a function to the callback-loop for this task """
        if callback\
    ...
    def _set_result(self, cb):
        """ Base callback function to catch results if main process is busy while receiving"""
